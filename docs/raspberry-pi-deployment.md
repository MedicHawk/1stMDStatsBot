...
DISCORD_LEADERBOARD_TYPES=kills,aikills,hours,xp,support,treatment,support_amount
DISCORD_KILL_FEED_ENABLED=true
DISCORD_KILL_FEED_POST_SECONDS=10
DISCORD_SUPPORT_FEED_ENABLED=true
DISCORD_SUPPORT_FEED_POST_SECONDS=15
